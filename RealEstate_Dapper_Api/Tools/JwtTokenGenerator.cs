...
namespace RealEstate_Dapper_Api.Tools
{
    public class JwtTokenGenerator
    {
        ...
        {
            var claims = new List<Claim>();                              //Token oluşturma
            ...
            var signinCreditentals = new SigningCredentials(key,SecurityAlgorithms.HmacSha256);
            ...
            JwtSecurityToken token = new JwtSecurityToken(issuer: JwtTokenDefaults.ValidIssuer, audience: JwtTokenDefaults.ValidAudience,
                claims: claims, notBefore: DateTime.UtcNow, expires: expireDate, signingCredentials: signinCreditentals);
